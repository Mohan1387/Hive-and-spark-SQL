...
select a.attacker_username,a.eventdate,a.eventtime, b.destination_host_name,sum(b.bytes_out) as url_bytes
...
where dir = '${hiveconf:PRESENTDATE}'
...
group by a.attacker_username,a.eventdate,a.eventtime,b.destination_host_name;
